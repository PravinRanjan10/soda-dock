...
mkdir -p /etc/opensds && sudo cat > /etc/opensds/soda-dock.conf <<OPENSDS_GLOABL_CONFIG_DOC
[osdsapiserver]
api_endpoint = 0.0.0.0:50040
auth_strategy = keystone
# If https is enabled, the default value of cert file
# is /opt/opensds-security/opensds/soda-dock-cert.pem,
# and key file is /opt/opensds-security/opensds/soda-dock-key.pem
https_enabled = False
...
#### Download cli tool.
```
wget https://github.com/opensds/soda-dock/releases/download/v0.5.2/opensds-hotpot-v0.5.2-linux-amd64.tar.gz
